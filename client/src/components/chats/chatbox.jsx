    ...
    return (
        <Stack gap={4} className='chat-box'>
            ...
            <Stack gap={3} className="messages">
                {
                    messages && messages.map((message, index) => {
                        ...
                        >
                            ...
                            <span className='message-footer'> {moment(message.createdAt)}</span>
                        </Stack>
            ...
            <Stack direction="horizontal" gap={3} className='chat-input flex-grow-0'>
                <InputEmoji value={textMessage} onChange={getTextMessage} fontFamily='nunito' borderColor="rgba(72,112,223,0.2" />
